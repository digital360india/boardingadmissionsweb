    ...
    <div className="lg:flex w-full md:px-[100px] lg:p-[40px] px-[24px] xl:h-[600px] lg:h-[480px] lg:py-0 py-12 bg-[#F4FCFC]">
      ...
      <div className="lg:w-1/2 w-full flex justify-center items-center">
        <div>
          ...
          <div className="xl:text-18px lg:text-16px pb-4">
            <p>
          ...
          <div className="lg:py-0 py-4 ">
            <button className="border text-white rounded-md w-[223px] py-2 bg-gradient-to-r from-[#075D70] via-[#A1C5CD] to-[#dfdfdf]">
              Know More
            </button>
          </div>
        </div>
