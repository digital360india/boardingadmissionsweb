...
export default function Login() {
  return (
    <div className="">
      <div className="w-full h-[100vh] mt-48 mb-16 flex justify-center items-center xl:px-[100px] lg:px-[35px] mx-10 pr-8"> 
          ...
          <div className="flex justify-between space-x-14">
            <div className="w-[426px] ">
              ...
              <div className="pt-8 flex-col space-y-4">
                ...
                <div className="flex-col xl:space-y-6 lg:space-y-4 xl:pt-6 pt-4 space-y-10">
                  <div>
                    <button
                      type="submit"
