...
const OurCourses = () => {
  return (
    <div 
      className="w-full h-[480px] bg-no-repeat bg-cover bg-center relative mt-20 lg:mt-24" 
    ...
    >
      <div className='w-[19rem] md:w-[470px] px-8 md:px-16   absolute  bottom-20  text-white  '>
        ...
        <p className='mt-2 text-sm md:text-lg'>Lorem ipsum dolor sit amet consectetur. Id lectus gravida convallis</p>
