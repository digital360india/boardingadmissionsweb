...
export default function ContactForm() {
  return (
    <div>
    <div className='  xl:px-[100px] lg:px-[40px] pb-[110px]  px-6 flex flex-col lg:flex-row justify-between space-y-10'>
    <div className='space-y-4  lg:pr-6'>
        ...
        <div className='space-y-8 '>
            ...
            <p>First name *</p>
            <input className='py-[12px] px-[16px] w-full  border rounded-md'  placeholder='First name *' type="text" />
            </div>
            <div className='space-y-4'>
            <p>Last name *</p>
    ...
    <div className='space-y-4'>
     <p className='text-[32px] font-medium'>Boarding Admissions</p>
        <p className='text-[18px] lg:w-[340px]'>Lorem ipsum dolor sit amet consectetur. Id nisi et consectetur gravida suspendisse gravida. Mattis.</p>
        <p className='text-[18px] lg:w-[340px]'>Lorem ipsum dolor sit amet consectetur. Id nisi et consectetur gravida suspendisse gravida. Mattis.</p>
     </div>
       <div className='space-y-4'>
