...
export default function ContactForm() {
  return (
    <div>
        <div className='px-[100px] py-[110px] flex justify-between'>
        <div className='space-y-4'>
            <p className='text-[48px]'>Have an enquiry?</p>
            <p className='text-[18px] w-[600px]'>We’d love to hear from you! Please fill out the form below and we
            ...
            <div className='space-y-8 '>
                ...
                <div className='space-y-4 '>
                <p>First name *</p>
                <input className='py-[12px] px-[16px] border rounded-md'  placeholder='First name *' type="text" />
                </div>

                <div className='space-y-4'>
                <p>Last name *</p>
                <input className='py-[12px] px-[16px] border rounded-md' placeholder='Last name *' type="text" />
                </div>
                </div>
            
            <div className='space-y-4'>
            <p>Email *</p>
            <input className='py-[12px] px-[16px] w-full border rounded-md' placeholder='Last name *' type="text" />
            </div>
            
            <div className='space-y-4'>
            <p>Phone number *</p>
            <input className='py-[12px] px-[16px] w-full border rounded-md' placeholder='123456789 *' type="text" />
            </div>
            <div className='space-y-4'>
                <p>Your message</p>
                <textarea className='h-[110px] w-full border rounded-md' name="" id=""></textarea>
            </div>
            <button className='text-white bg-gradient01 py-[20px] rounded-xl w-full text-[24px] font-medium '>
            Send message
            </button>
            </div>
        </div>
