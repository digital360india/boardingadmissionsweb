  ...
  return (
    <div className='flex h-full w-full'>
        ...
        <div className='bg-[#F4FCFC] '>
            ...
            <p className='text-[16px]   text-center px-[20%]'>Id pellentesque arcu fermentum euismod neque turpis amet amet. Id in sit aliquet vel neque adipiscing. Cursus nisi scelerisque orci vivamus est in. Hac quam magna.Id</p>
...
<div className='absolute inset-0 top-0 left-6 text-center w-[40%]'>
    <p className='text-32px text-primary02   pb-4'>lorem ipsum</p>
