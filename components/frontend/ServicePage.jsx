...
const ServicePage = () => {
  ...
  return (
    <>
      <div>
        <div className="">
          <div className="mx-4 mt-2 md:mx-20 md:mt-14 md:flex md:justify-between md:items-center">
            <div id="onlineclass" className="md:w-1/2">
              <h1 className="lg:text-[48px] text-[32px]  md:text-[3.5rem] text-primary02">
                Online Class
              </h1>
          ...
          <div className="bg-gradient-to-br from-[#075D70] to-[#0DB2D6]">
            <div className="mx-4 mt-4 md:mt-8 md:px-20 md:flex md:justify-between md:space-x-14  md:pt-12 md:pb-12 w-[100%]">
              <div className="hidden md:flex md:justify-between  md:space-x-6 w-[50%]">
                <Image
                  src="/icons/PI1.svg"
                  width={1000}
                  height={1000}
              ...
              <div id="personalinterview" className="w-[50%]">
                <h1 className="lg:text-[44px] text-[28px] text-white">
                  Personal Interview Preparation
                </h1>
                <p className="text-[0.875rem] md:text-[20px] leading-relaxed text-white mt-4">
          ...
          <div className="mx-4 mt-4 md:mt-8 md:mx-20 md:flex md:justify-between md:items-center">
            <div className="md:w-1/2" id="mocktest">
          ...
          <div className="bg-gradient-to-br from-[#075D70] to-[#0DB2D6] mt-8">
            <div className="bg-gradient-to-br from-[#075D70] to-[#0DB2D6] overflow-hidden">
              <div className="mx-4 mt-4 md:mt-8 md:mx-20 md:flex md:justify-between md:items-center md:space-x-12 md:pt-12 md:pb-12">
