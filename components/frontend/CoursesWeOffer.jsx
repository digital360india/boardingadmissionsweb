  ...
  return (
    <div className="bg-[#075D70] xl:px-[100px] lg:px-[40px] px-[12px] pt-[60px]">
      <div className="lg:ml-0 ml-4">
        <div>
          <p className="lg:text-24px text-[16px] py-2 text-white  ">
            COURSES WE OFFER
          </p>
        </div>
        <div className="lg:text-[48px] text-[32px] text-white font-medium lg:leading-normal leading-tight lg:w-[848px] w-full">
