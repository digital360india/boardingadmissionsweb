...
export default function HeroImage() {
  ...
  >
    <div className="lg:w-[31.25rem]  lg:px-16 pl-[24px]   absolute  bottom-20 text-white  ">
      ...
      <p className='lg:text-18px text-14px lg:w-full w-[230px] my-4'>Explore our comprehensive list of top schools, each offering exceptional boarding experiences to help students thrive academically and personally.</p>
