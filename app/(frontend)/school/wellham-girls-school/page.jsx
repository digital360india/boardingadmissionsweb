  ...
  return (
    <>
      <head>
        ...
        <title>Welham girls school | Admission 2025-26</title>

        <meta
          name="description"
          content="Join Welham Girls' School, Dehradun, for 2025-2026 admissions. Empowering girls through exceptional education and character-building experiences."
        />

        <meta
          name="keywords"
          content="Boarding School Admissions,  Boarding School consultancy, School consultancy, Boarding Admissions, Boarding School Entrance Prep, Welham Girls, Welham Girls admission, Welham Girls entrance "
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image:
                "https://www.boardingadmissions.com/largescreen/welhamgirls.png",
              description:
