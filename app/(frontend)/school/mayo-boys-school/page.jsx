...
export const metadata = {
  ...
  title: "Mayo Boys School | Admission 2025-26",
  description:
    "Mayo Boys School offers world-class education with holistic development. Admission for 2025-2026 is open—apply now for a transformative learning experience.",
  keywords:
    "Boarding School Admissions, Boarding School consultancy, School consultancy, Boarding Admissions, Boarding School Entrance Prep, Mayo Boys, Mayo Boys admission, Mayo Boys entrance",
  openGraph: {
    locale: "en_US",
    type: "website",
    title: "Mayo Boys School | Admission 2025-26",
    ...
    images: [
      {
        url: "https://www.boardingadmissions.com/largescreen/mayoboys.png",
        width: 800,
        height: 600,
        alt: "Mayo Boys School",
      },
    ],
  },
  structuredData: [
