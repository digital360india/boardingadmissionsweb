    ...
    <>
      <html lang="en">
        <head>
          ...
          <title>Welham Boys School | Admission 2025-26</title>
          <meta
            name="description"
            content="Join Welham Boys School for 2025-2026! Provide your child with top-tier education and a nurturing environment. Apply today!"
          />
          <meta
            name="keywords"
            content="Boarding School Admissions, Boarding School consultancy, School consultancy, Boarding Admissions, Boarding School Entrance Prep, Welham Boys, Welham Boys admission, Welham Boys entrance"
          />
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                image:
                  "https://www.boardingadmissions.com/largescreen/welhamboys.png",
                description:
