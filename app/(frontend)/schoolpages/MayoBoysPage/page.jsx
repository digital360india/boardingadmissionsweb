...
<head>
  ...
  <meta name="description" content="Mayo Boys School offers world-class education with holistic development. Admission for 2025-2026 is open—apply now for a transformative learning experience." />
  <meta name="keywords" content="Boarding School Admissions, Boarding School consultancy, School consultancy, Boarding Admissions, Boarding School Entrance Prep, Mayo Boys, Mayo Boys admission, Mayo Boys entrance" />

  <script type="application/ld+json" class="schema" dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      "@context": "https://schema.org/",
      "@type": "Product",
      "name": "Boarding Admission",
      "image": "https://www.boardingadmissions.com/largescreen/mayoboys.png",
      "description": "Join Mayo Boys School for the 2025-2026 session! Experience top-notch education, excellent facilities, and a vibrant community. Enroll now for a bright future!",
      "brand": {
        "@type": "Brand",
  ...
  <script type="application/ld+json" class="schema" dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "address": {
        ...
        "description": "Apply now for Mayo Boys' School Admission 2025-2026! Discover top-notch education, holistic development, and a nurturing environment. Secure your spot today!"
      },
