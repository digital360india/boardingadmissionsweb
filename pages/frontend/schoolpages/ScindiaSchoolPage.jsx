  ...
  return (
    <div className='h-auto w-[100%]'>
      ...
      <div className='w-[90%] ml-[5%] mt-[5%] '>
        ...
        <div className='relative h-[22vh] sm:h-[15vh] md:h-[14vh] xl:h-[17vh]  w-full  border-b-2  sm:flex sm:justify-between'>
