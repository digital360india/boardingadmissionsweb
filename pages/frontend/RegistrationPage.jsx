  ...
  return (
    <div className="px-[100px] mx-auto">
      <div className="">
        ...
        <p className="font-normal text-18px text-[#8692A6]">
          We are happy to have you here
        </p>
      </div>
      <div className="pt-10">
        <p className="text-primary02 font-medium text-24px">Primary Details</p>
      ...
      <div>
        <p className="text-primary02 font-medium text-24px">
          Educational Details
        </p>
      ...
      <div className="py-20">
        <button className="bg-gradient01 text-16px font-medium text-white w-[29vw] h-[9.5vh] rounded-md">
          Submit
        </button>
      </div>
    </div>
