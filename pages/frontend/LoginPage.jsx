...
export default function LoginPage() {
  return (
    <div className="w-full h-[100vh] my-20 flex justify-center items-center ">
      <div className="w-[1140px] h-[690px] ">
        <div className="flex justify-between space-x-14">
          <div className="w-[426px] ">
            ...
            <p className="text-18px font-normal text-[#8692A6]">
            ...
            <div className="pt-8 flex-col space-y-4">
              <div className="flex-col space-y-4">
                ...
                <input
                  className="font-normal text-14px text-[#8692A6] bg-[#E6E6E64D] rounded-md border border-[#075D70] p-4 w-[421px] h-[64px]"
              ...
              <div className="flex-col space-y-4">
                ...
                <input
                  className=" rounded-md border border-[#075D70] font-normal text-14px text-[#8692A6] p-4 w-[421px] bg-[#E6E6E64D] h-[64px]"
                  type="text"
